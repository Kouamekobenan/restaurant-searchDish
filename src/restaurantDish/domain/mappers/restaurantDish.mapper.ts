...
export class RestaurantDishMapper {
  toEntity(prismaModel: prismaEntity): RestaurantDish {
  ...
  toPersistence(createRestDish: CreateRestaurantDishDto):Prisma.RestaurantDishCreateInput{
    return {
  ...
  toUpdate(updateRestauDish:UpdateRestaurantDishDto):Prisma.RestaurantDishUpdateInput{
    const dataRestDish: Prisma.RestaurantDishUpdateInput={};
    if (updateRestauDish.restaurantId !==undefined) {
        dataRestDish.restaurant= {connect:{id:updateRestauDish.restaurantId}}
    }
